  ...
  >
    <q-card class="my-card rounded-1" style="width: 600px; max-width: 96vw !important;">
      <q-card-section class="column no-wrap flex-center">
        <q-icon v-if="type === 'success'" name="check_circle" color="positive" size="70px" class="q-ma-lg" />
        <q-icon v-if="type === 'error'" name="error_outline" color="negative" size="70px" class="q-ma-lg" />
        <q-icon v-if="type === 'question'" name="help" color="warning" size="70px" class="q-ma-lg" />
        <q-icon v-if="type === 'warning'" name="notification_important" color="warning" size="70px" class="q-ma-lg" />
        <q-icon v-if="type === 'warningpositive'" name="notification_important" color="positive" size="70px" class="q-ma-lg" />
      </q-card-section>
      ...
      <q-card-actions align="center" class="q-ma-lg justify-around">
        ...
        <q-btn
          ...
          @click="onCancelClick"
        />
        <q-btn v-if="cancel" unelevated size="md" color="primary" :label="evetText" class="rounded-3" @click="onOKClick" />
      </q-card-actions>
    </q-card>
  </q-dialog>
</template>
