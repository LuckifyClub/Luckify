      ...
      <div class="container column full-width items-center q-mt-lg">
        ...
        <div class="centrik z-max column items-center" :class="om('q-my-none')">
          <h1 class="flex no-wrap fold" :class="om('column q-mx-none q-pa-none items-center')+od('q-mx-xl')">
            ...
            <div class="text-h5  text-black" :class="od('q-pa-md')+om('text-center')">a platform that elevates the traditional lotto experience with its reliable
              onchain technology and with a bonus that's practically <span class="fan text-h3">unbeatable</span>, it's no wonder we're
              the go-to destination for players looking to <span class="fan text-h3">hit it big</span>.</div>
          </h1>
          ...
          <div class="flex row" :class="od('q-ma-xl')+om('q-mx-md full-width q-my-none')">
            ...
            <div class="box column items-center  col-md col-xs-12">
              <h3 class="text-h4 q-pa-none q-ma-none text-center text-bold">Privacy is <br> a Top Priority</h3>
          ...
          <div>
            <div class="column flex-center text-h5 " :class="od('q-pa-xl')+om('q-pa-sm')">
              ...
              <div class=" column flex-center full-width" :class="od('q-px-xl q-mx-xl')">
                <div class="flex no-wrap justify-between full-width bg-secondary rounded-borders q-mb-sm" :class="od('q-px-xl q-mx-xl')+om('q-pa-sm')">
            ...
            <div class="extra text-center bg-primary text-white q-pa-md text-body2 rounded-borders q-mb-md q-mx-sm">In addition, <b>200 participants</b> will receive prizes worth 0.75 ETH (~$1000).</div>
            <div class="text-center q-mx-sm">* Prizes will be awarded in percentage of tickets sold. The prizes shown are only eligible if all tickets are sold.</div>
          </div>
        </div>
        ...
        <div class="column flex-center q-px-md">
          ...
          <div class=" text-body1 text-center  text-black" :class="od('q-px-xl q-mx-xl')">Yes, our lottery is open to players from any location. However, we advise you to pay attention to the regulations in your country and not to do any illegal business.</div>
...
.box{padding:20px;margin:20px; width:100%; max-width: 90vw; border-radius:40px;box-shadow:0 10px 30px -15px #000;background:#ebfcef;}
...
.luckyfish {max-height: 50vh; max-width: 90vw;}
