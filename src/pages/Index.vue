          ...
          <div class="logo-group flex column justify-center items-center q-px-xl col-3">
            ...
            <h1 class="flex" :class="om('column q-mx-none q-pa-none items-center') + od('q-mx-sm')">
                ...
                <div class="text-h6 text-green-10 text-center" :class="od('q-pa-md') + om('')">
                  ...
                  a blockchain-based gaming platform that provides transparent, secure, and fully provable randomization for game results. Join us for the world's <span class="fan text-h4">smartest</span> and most profitable gaming experience.
                </div>
              </h1>
...
<div class="col-9">
            <div class="z-max column items-center" :class="om('q-my-none')">
              ...
              <div class="section column items-center">
                <h2 class="fan q-pa-none text-center" :class="od('text-h1 q-ma-none') + om('text-h3 q-mx-md')">Our games</h2>
